...
USVFunction usv;
HCSR04 hc(14, new int[3]{4,5,12}, 3); //initialisation class HCSR04 (trig pin , echo pin, number of sensor)
...
void loop(){
  ...
  temp_front = hc.dist(0);
  temp_left = hc.dist(1);
  temp_right = hc.dist(2);
  ...
  distance_right = distance_right/8;
  if (count_idle_right >= 20)
  {
    count_idle_right = 20;
    distance_right = 10;
  }
