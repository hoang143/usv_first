...
Rectangle {
    ...
    property string interpolatePath
    property alias cameraSource: cameraImage.source
...
//                    maxZValue: 21.00688017
    ...
    RowLayout {
        ...
        NewButton {
            id: interpolateFromFile
            Layout.fillWidth: true
            Layout.fillHeight: true
            text: "Interpolate From File " + logFile.getInterpolateProgress + "%" + " ( " + logFile.getPauseCount + " iter)"
            //! [3]
            onClicked: {
                interpolateFileDialog.open()
            }
            onTextChanged: {
                interpolatePulse.restart()
            }
        ...
        Image {
            id: cameraImage
            cache: false
            source: "file:///D:/1. Bach Khoa/LAB FDCL/2. USV/5.Qt/gcs_user_3_3/QtApp/black.jpg"
        }
        Timer{
            id: refreshImagePulse
            interval: 2000; running: true; repeat: true
            onTriggered: {
                cameraSource = "http://192.168.79.171/capture"
                refreshImagePulse2.restart()
            }
        }
        Timer{
            id: refreshImagePulse2
            interval: 1900; running: false; repeat: false
            onTriggered: {
                cameraSource = "file:///D:/1. Bach Khoa/LAB FDCL/2. USV/5.Qt/gcs_user_3_3/QtApp/black.jpg"
            }
        }
    }
