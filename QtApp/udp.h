...
class udp :public QObject
{
    ...
    Q_PROPERTY(float distanceToHome READ qml_read_distance_to_home NOTIFY onReceivedPacket)
...
private:
    ...
    // ------SET PARAMETERS ------
        float a_send = 2;                    // Index 22
        float b_send = 20;                    // Index 23
        float k_moment_send = 175;             // Index 24
        float cruise_send = 160;               // Index 25
        float arrival_radius_send = 2;       // Index 26
        float zigzag_step_send = 1;          // Index 27
        float look_ahead_send = 5;           // Index 28
    ...
    // ------ QT States: MODE 1 ------
        ...
        double target_lng_mode_1 = 0;

    // ------ QT States: MODE 2 ------
        double target_lat_1_mode_2 = 0;
        double target_lng_1_mode_2 = 0;
        double target_lat_2_mode_2 = 0;
        double target_lng_2_mode_2 = 0;
        double target_lat_3_mode_2 = 0;
        double target_lng_3_mode_2 = 0;
        double target_lat_4_mode_2 = 0;
        double target_lng_4_mode_2 = 0;

    // ------ QT States: MODE 3 ------
        double target_lat_1_mode_3 = 0;
        double target_lng_1_mode_3 = 0;
        double target_lat_2_mode_3 = 0;
        double target_lng_2_mode_3 = 0;

    // ------ USV States ------
        bool auto_mode = 0;             // Index 0
        int select_auto_mode = 0;       // Index 1
        int thrust = 0;                 // Index 2
        int moment = 0;                 // Index 3
        int speed_1 = 0;                // Index 4
        int speed_2 = 0;                // Index 5
        float usv_yaw = 0;              // Index 6
        float desire_yaw = 0;           // Index 7
        ...
        float k_yaw_error = 0;          // Index 20
        float k_distance = 0;           // Index 21
        float a = 0;                    // Index 22
        float b = 0;                    // Index 23
        float k_moment = 0;             // Index 24
        int cruise = 0;                 // Index 25
        float arrival_radius = 0;       // Index 26
