...
// ------ SET PARAMETERS ------
    ...
    void udp::send_parameters(bool _val)
    {
        ...
        {
            for(int i = 0; i < 20; i++){
                sendPacket(4210,QHostAddress("192.168.1.52"),"%," + num_to_udp_string(a_send,3,0)
            ...
            for(int i = 0; i < 20; i++){
                sendPacket(3210,QHostAddress("192.168.1.38"),"%," + num_to_udp_string(a_send,3,0)
                                                                  + num_to_udp_string(b_send,3,0)
                                                                  + num_to_udp_string(k_moment_send,3,0)
                                                                  + num_to_udp_string(cruise_send,3,0)
                                                                  + num_to_udp_string(arrival_radius_send,3,0)
...
// ------ QT States: MODE 0 ------
    ...
    void udp::send_manual(bool _val)
    {
        ...
        {
            for(int i = 0; i < 20; i++){
                sendPacket(4210,QHostAddress("192.168.1.52"),"#," + num_to_udp_string(thrust_send,3,0)
                                                                 + num_to_udp_string(moment_send,3,0));
            }
            for(int i = 0; i < 20; i++){
                sendPacket(3210,QHostAddress("192.168.1.38"),"#," + num_to_udp_string(thrust_send,3,0)
                                                                 + num_to_udp_string(moment_send,3,0));
            }
        }
    }
...
// ------ QT States: MODE 2 ------
    ...
    void udp::send_mode_2 (bool _val)
    {
        ...
        {
            for(int i = 0; i < 20; i++){
                sendPacket(4210,QHostAddress("192.168.1.52"),"!" + num_to_udp_string(target_lat_1_mode_2,2,9)
            ...
            for(int i = 0; i < 20; i++){
                sendPacket(3210,QHostAddress("192.168.1.38"),"!" + num_to_udp_string(target_lat_1_mode_2,2,9)
                                                                 + num_to_udp_string(target_lng_1_mode_2,3,9)
                                                                 + num_to_udp_string(target_lat_2_mode_2,2,9)
                                                                 + num_to_udp_string(target_lng_2_mode_2,3,9)
                                                                 + num_to_udp_string(target_lat_3_mode_2,2,9)
...
// ------ QT States: MODE 3 ------
    ...
    void udp::send_mode_3 (bool _val)
    {
        ...
        {
            for(int i = 0; i < 20; i++){
                sendPacket(4210,QHostAddress("192.168.1.52"),">" + num_to_udp_string(target_lat_1_mode_3,2,9)
            ...
            for(int i = 0; i < 20; i++){
                sendPacket(3210,QHostAddress("192.168.1.38"),">" + num_to_udp_string(target_lat_1_mode_3,2,9)
                                                                 + num_to_udp_string(target_lng_1_mode_3,3,9)
                                                                 + num_to_udp_string(target_lat_2_mode_3,2,9)
                                                                 + num_to_udp_string(target_lng_2_mode_3,3,9));
            }
